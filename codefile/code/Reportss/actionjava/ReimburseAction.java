...
public class ReimburseAction extends PermissionAction {
	...
	public String query() {
		...
		Specification<Application> spec = reimburse == null ? null : (new Specification<Application>() {
			@Override
			public Predicate toPredicate(Root<Application> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if (!StringHelper.isEmpty(reimburse.getId())) sq.ilike("code", reimburse.getId());
	...
	/** 当前要处理的人员 */
	protected Application reimburse;

	public Application getReimburse() {
		return reimburse;
	}

	public void setReimburse(Application reimburse) {
