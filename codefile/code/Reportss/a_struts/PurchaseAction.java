...
public class PurchaseAction extends PermissionAction {
	...
	public String query() {
		...
		Specification<Application> spec = purchase == null ? null : (new Specification<Application>() {
			@Override
			public Predicate toPredicate(Root<Application> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
				...
				if (!StringHelper.isEmpty(purchase.getId())) sq.ilike("code", purchase.getId());
	...
	/** 当前要处理的人员 */
	protected Application purchase;

	public Application getPurchase() {
		return purchase;
	}

	public void setPurchase(Application purchase) {
